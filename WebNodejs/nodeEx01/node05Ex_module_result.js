...
var myModule= require("./node05Ex_module_create");
...
var server = http.createServer(function(request, response){
	...
	request.on('end', function(){
		...
		response.write("1. " + myModule.odd(parseQuery.num) + "<br/>");
		response.write("2. " + myModule.even(parseQuery.num)+"<br/>");
		response.end("3. " + myModule.sum(parseQuery.num)+"<br/>");
	});
});
